...
DATA_FILES = [
	...
	('/usr/share/updf',glob.glob('src/*')),
	('/usr/share/updf/icons',glob.glob('data/icons/*.svg')),
	('/usr/share/updf/css',glob.glob('data/css/*.css')),
	('/usr/share/applications',['data/updf.desktop']),
	]
